...
# print(cargamos)
# Inserta un valor de acuerdo a la posicion indica
#cargamos.insert(1, "Alfredo")
# print(cargamos)
...
# print(cargamos)
# cargamos.sort(reverse=True)  # Ordenar la lista de forma descendente
# print(cargamos)
