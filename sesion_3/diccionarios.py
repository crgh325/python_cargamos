...
clientes = [
    ...
    {'cuenta': '2334457', 'apellido': 'Cespedes',
        'nombre': 'Javier', 'saldo': 9000},
    {'cuenta': '2334458', 'apellido': 'Linares', 'nombre': 'Oscar', 'saldo': 12000},
    {'cuenta': '2334459', 'apellido': 'Palomino',
        'nombre': 'Maria', 'saldo': 170000}
]
cuenta = input("Ingrese su numero de cuenta a consultar:")
for item in clientes:
    if (cuenta == item['cuenta']):
        print('{}, {}, tu saldo actual es de: {}'.format(
            item['apellido'], item['nombre'], item['saldo']))
        break
